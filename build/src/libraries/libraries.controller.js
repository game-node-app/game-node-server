...
var libraries_service_1 = require("./libraries.service");
var auth_guard_1 = require("../auth/auth.guard");
var swagger_1 = require("@nestjs/swagger");
var session_decorator_1 = require("../auth/session.decorator");
var LibrariesController = (function () {
    function LibrariesController(librariesService) {
        this.librariesService = librariesService;
    }
    LibrariesController.prototype.findByUserId = function (session) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.librariesService.findByUserId(session.getUserId())];
            });
        });
    };
    LibrariesController.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.librariesService.findById(id)];
            });
        });
    };
    __decorate([
    ...
    ], LibrariesController.prototype, "findByUserId", null);
    __decorate([
        (0, common_1.Get)(":id"),
        openapi.ApiResponse({ status: 200, type: Object }),
        ...
        __metadata("design:returntype", Promise)
    ], LibrariesController.prototype, "findById", null);
    LibrariesController = __decorate([
