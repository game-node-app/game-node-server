...
var CollectionEntry = (function () {
    ...
    CollectionEntry._OPENAPI_METADATA_FACTORY = function () {
        return { id: { required: true, type: function () { return Number; }, description: "Not to be confused with the igdbId property from GameMetadata" }, data: { required: true, type: function () { return require("../../utils/game-metadata.dto").GameMetadata; } }, collection: { required: true, type: function () { return require("./collection.entity").Collection; } } };
    };
    __decorate([
